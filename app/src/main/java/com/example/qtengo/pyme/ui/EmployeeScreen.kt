...
/**
 * Pantalla para la gestión de la plantilla de empleados en el perfil Pyme.
 * Permite visualizar el coste salarial total y gestionar las altas/bajas.
 */
@Composable
fun EmployeeScreen(
    profile: String = "PYME",
    ...
    Column(
        ...
        // Resumen rápido de plantilla y costes
        Card(
...
/**
 * Tarjeta individual para mostrar información resumida de un empleado.
 */
@Composable
...
/**
 * Diálogo flotante para capturar los datos de un nuevo empleado.
 */
@Composable
    ...
    AlertDialog(
        ...
        text = {
            Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
                ...
                OutlinedTextField(value = sal, onValueChange = { if (it.isEmpty() || it.toDoubleOrNull() != null) sal = it }, label = { Text("Salario Mensual") })

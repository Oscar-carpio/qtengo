...
/**
 * Clase de datos para las opciones del menú principal de Pyme.
 */
data class PymeMenuOption(val title: String, val icon: String, val color: Color)

/**
 * Pantalla principal del perfil Pyme.
 * Muestra un resumen del estado del negocio y acceso a los módulos de gestión.
 * 
 * @param onMenuSelected Callback disparado al seleccionar un módulo.
 * @param onLogout Callback para cerrar la sesión del usuario.
 * @param onChangeProfile Callback para cambiar el rol/perfil actual.
 * @param productViewModel ViewModel para obtener datos de stock en tiempo real.
 */
@Composable
fun PymeHomeScreen(
    ...
    Column(
        ...
        // Barra superior con gestión de sesión centralizada
        QtengoTopBar(
            title = "Panel Pyme",
            onLogout = onLogout,
        ...
        // Sección de indicadores rápidos (Dashboard)
        DashboardSection(
...
/**
 * Muestra tarjetas de resumen con indicadores clave de la empresa.
 */
@Composable
...
/**
 * Tarjeta informativa individual para el Dashboard.
 */
@Composable
...
/**
 * Tarjeta interactiva para acceder a cada módulo de gestión.
 */
@Composable
